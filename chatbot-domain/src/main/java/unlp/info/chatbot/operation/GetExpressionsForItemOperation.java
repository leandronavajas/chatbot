...
@Component
public class GetExpressionsForItemOperation implements Operation<GetExpressionsForItemRequest, List<EntityPersistent>> {
  ...
  public List<EntityPersistent> execute(GetExpressionsForItemRequest request) {
    return this.messageRepositoryService.getExpressions(request.getCategoryId(), request.getItemId());
  }
